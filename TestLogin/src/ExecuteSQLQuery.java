		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					frame.setVisible(true);				// afisara interfata executare cereri
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	public ExecuteSQLQuery() {
		...
		btnNewButton_1.addActionListener(new ActionListener() {			// addActionListener este folosit pentru a atribui functionalitate unui buton
			public void actionPerformed(ActionEvent arg0) {
				...
				Interfata object = new Interfata();						// ma intorc la interfata de unde pot sa selectez de la ce tabel sa vizualizez date sau sa modific inregistrari
